...
function displayItems(){
    ...
    biryaniData.map(item=>{
        ...
        itemPrice.innerText= 'Price : INR ' + item.price;
...
function totalAmount(){
    ...
    document.getElementById('total-price').innerText= 'Total Price : INR ' + sum;
    document.getElementById('m-total-amount').innerText= 'Total Price : INR ' + sum;
}
